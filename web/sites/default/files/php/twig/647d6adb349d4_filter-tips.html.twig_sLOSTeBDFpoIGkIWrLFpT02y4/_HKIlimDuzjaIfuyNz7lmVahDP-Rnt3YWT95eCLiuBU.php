...
class __TwigTemplate_0e25f937c595355c08e91c06d3c5710b extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-" . twig_replace_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 45), 45, $this->source), ["/" => "-"]))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "core/themes/seven/templates/classy/content-edit/filter-tips.html.twig", "/opt/lampp/htdocs/DrupalV9Basic/web/core/themes/seven/templates/classy/content-edit/filter-tips.html.twig");
    }
